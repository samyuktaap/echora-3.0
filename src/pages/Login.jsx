    ...
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '2rem', position: 'relative', background: 'var(--bg-secondary)' }}>
        ...
        <div style={{ width: '100%', maxWidth: 420 }}>
          ...
          {!supabaseConfigured && (
            <div style={{ marginBottom: '1.5rem', padding: '1rem', borderRadius: '14px', background: 'rgba(239,68,68,0.08)', border: '1px solid rgba(239,68,68,0.15)', color: '#991b1b' }}>
              <strong>Supabase is not configured.</strong> Copy <code>.env.example</code> to <code>.env</code> and add your <code>VITE_SUPABASE_URL</code> and <code>VITE_SUPABASE_ANON_KEY</code> before signing in.
            </div>
          )}
