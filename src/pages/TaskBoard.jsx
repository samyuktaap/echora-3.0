...
const TaskBoard = () => {
  const taskBannerImage = 'https://images.unsplash.com/photo-1492684223066-81342ee5ff30?auto=format&fit=crop&w=1200&q=80';
  ...
  return (
    <div className="page-container" style={{ maxWidth: '1000px', margin: '0 auto' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1.15fr 320px', gap: '1rem', marginBottom: '2rem', alignItems: 'stretch' }}>
        <div style={{ borderRadius: '24px', overflow: 'hidden', minHeight: '220px', position: 'relative', background: 'linear-gradient(135deg, rgba(74,114,212,0.12), rgba(201,168,76,0.08))' }}>
          <img src={taskBannerImage} alt="Volunteers supporting community causes" loading="lazy" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
          ...
          <div style={{ position: 'absolute', bottom: 0, left: 0, right: 0, padding: '1.5rem', color: 'white' }}>
            <p style={{ margin: 0, fontSize: '0.9rem', letterSpacing: '0.12em', textTransform: 'uppercase', opacity: 0.9 }}>Featured mission</p>
            <h2 style={{ margin: '0.5rem 0 0', fontSize: '1.7rem', lineHeight: 1.1, fontWeight: 800 }}>Discover tasks with local impact</h2>
            <p style={{ margin: '0.8rem 0 0', lineHeight: 1.5, maxWidth: 360, color: 'rgba(255,255,255,0.92)' }}>Every opportunity is crafted to help your community and match your skills.</p>
          </div>
        </div>
        <div style={{ borderRadius: '24px', padding: '1.5rem', background: 'var(--bg-secondary)', border: '1px solid var(--border-color)', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', minHeight: '220px' }}>
          <div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1rem' }}>
              <Zap style={{ color: 'var(--gold-mid)' }} size={22} />
              <div>
                <div style={{ fontSize: '0.82rem', fontWeight: 800, letterSpacing: '0.12em', textTransform: 'uppercase', color: 'var(--gold-mid)' }}>Recommended for you</div>
                <p style={{ margin: '0.35rem 0 0', color: 'var(--text-secondary)', fontSize: '0.95rem' }}>Top tasks curated based on your profile and recent activity.</p>
              </div>
            </div>
            <div style={{ display: 'grid', gap: '0.75rem' }}>
              <div style={{ padding: '1rem', borderRadius: '16px', background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.06)' }}>• Real-time matches from NGOs</div>
              <div style={{ padding: '1rem', borderRadius: '16px', background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.06)' }}>• Search by location, cause, and urgency</div>
              <div style={{ padding: '1rem', borderRadius: '16px', background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.06)' }}>• Apply instantly with one click</div>
            </div>
          </div>
        </div>
      </div>
